...
INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Фасонина (монтажные елементы)', NULL)

INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Вентиляторы', NULL)
  
INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Воздуховоды', NULL)

INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Электроуправляющие устройства', NULL)
...
INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Изоляция', NULL)
  
INSERT INTO ProductCategories 
	([Description], NAME, Parent_Id) 
VALUES
  ( NULL, N'Приточно-вытяжные установки', NULL)
