...
{
    public class NamedEntitiesRepository<TNamedEntity> : BaseOnlineStoreCRUDRepository<TNamedEntity>, INamedEntitiesRepository<TNamedEntity> where TNamedEntity : NamedEntity
    {
