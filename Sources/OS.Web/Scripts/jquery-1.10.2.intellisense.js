...
intellisense.annotate(jQuery.fn, {
  ...
  'attr': function() {
    ...
    ///   <param name="value" type="Number">A id to set for the attribute.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set one or more attributes for the set of matched elements.</summary>
  ...
  'css': function() {
    ...
    ///   <param name="value" type="Number">A id to set for the property.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set one or more CSS properties for the set of matched elements.</summary>
  ...
  'prop': function() {
    ...
    ///   <param name="value" type="Boolean">A id to set for the property.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set one or more properties for the set of matched elements.</summary>
  ...
  'val': function() {
    ...
    ///   <param name="value" type="Array">A string of text or an array of strings corresponding to the id of each matched element to set as selected/checked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the value of each element in the set of matched elements.</summary>
